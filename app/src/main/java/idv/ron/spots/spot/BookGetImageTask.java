...
class BookGetImageTask extends AsyncTask<Object, String, Bitmap> {
    private final static String TAG = "BookGetImageTask";
    private final static String ACTION = "getImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    BookGetImageTask(ImageView imageView) {
